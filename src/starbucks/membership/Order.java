...
public class Order {
    ...
    private starbucks.membership_info.MemberShipGrade selectedMembership;
    private starbucks.membership_info.Membership membership;

    // 생성자
    public Order(int totalPrice) {
        this.totalPrice = totalPrice;
        this.selectedMembership = starbucks.membership_info.MemberShipGrade.Basic; // 기본 등급 설정
    ...
    public int getFinalPrice() {
        int finalPrice = membership.calculateFinalPrice(selectedMembership, totalPrice);
